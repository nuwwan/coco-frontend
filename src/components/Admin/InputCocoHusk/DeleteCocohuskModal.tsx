/**
 * DeleteInputCocoHuskModal Component
 * Confirmation modal for deleting input husk lots
 */

interface DeleteInputCocoHuskModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  lotId: string;
...
const DeleteInputCocoHuskModal = ({
  isOpen,
  onClose,
  onConfirm,
  lotId,
  isLoading = false,
}: DeleteInputCocoHuskModalProps) => {
      ...
      <div className="relative bg-slate-800 border border-slate-700 rounded-xl shadow-2xl w-full max-w-md mx-4">
        ...
        <div className="p-6 text-center">
          ...
          <h2 className="text-xl font-semibold text-white mb-2">
            Delete Input Husk Lot
          </h2>
          <p className="text-slate-400">
            Are you sure you want to delete lot{' '}
            <span className="text-white font-medium">#{lotId}</span>?
...
export default DeleteInputCocoHuskModal;
