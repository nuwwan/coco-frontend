/**
 * DeleteSalaryPaymentModal Component
 * Confirmation modal for deleting salary payments
 */

interface DeleteSalaryPaymentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
...
const DeleteSalaryPaymentModal = ({
  isOpen,
  onClose,
  onConfirm,
  salaryPaymentInfo,
  isLoading = false,
}: DeleteSalaryPaymentModalProps) => {
      ...
      <div className="relative bg-slate-800 border border-slate-700 rounded-xl shadow-2xl w-full max-w-md mx-4">
        ...
        <div className="p-6 text-center">
          ...
          <p className="text-slate-400">
            ...
            <br />
            <span className="text-white font-medium">{salaryPaymentInfo}</span>
            <br />
...
export default DeleteSalaryPaymentModal;
