/**
 * DeleteOutputOrderModal Component
 * Confirmation modal for deleting output husk orders
 */

import type { OutputOrder } from "../../../utils/types";

interface DeleteOutputOrderModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  orderId?: number;
...
const DeleteOutputOrderModal = ({
  isOpen,
  onClose,
  onConfirm,
  orderId,
  isLoading = false,
}: DeleteOutputOrderModalProps) => {
...
export default DeleteOutputOrderModal;
