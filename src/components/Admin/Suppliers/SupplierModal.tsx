 ...
 * Modal form for creating and editing suppliers
 */
...
const SupplierModal = ({ isOpen, onClose, onSubmit, supplier, isLoading = false }: SupplierModalProps) => {
      ...
      <div className="relative bg-slate-800 border border-slate-700 rounded-xl shadow-2xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-slate-700 sticky top-0 bg-slate-800 z-10">
          <h2 className="text-xl font-semibold text-white">
            {isEditMode ? '✏️ Edit Supplier' : '🏭 Add New Supplier'}
          </h2>
          <button
            onClick={handleClose}
            ...
            <div className="pt-4 border-t border-slate-700">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div className="p-3 bg-slate-700/30 rounded-lg">
                  ...
                  <p className="text-white">{formatDate(supplier.createdAt)}</p>
                </div>
                <div className="p-3 bg-slate-700/30 rounded-lg">
                  <p className="text-slate-400">Updated At</p>
                  <p className="text-white">{formatDate(supplier.updatedAt)}</p>
                </div>
              </div>
            </div>
          )}
